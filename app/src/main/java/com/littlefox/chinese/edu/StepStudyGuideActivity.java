...
public class StepStudyGuideActivity extends BaseActivity
{
	@BindView(R.id.step_guide_title)
	TextView _TitleText;
	
	@BindView(R.id.step_guide_close)
	ImageView _CloseButton;
	
	@BindView(R.id.step_guide_webview)
	WebView _WebView;
	
	@BindView(R.id.step_guide_base)
	RelativeLayout _BaseLayout;
	
	@BindView(R.id.step_guide_progress_wheel_layout)
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		if(Feature.IS_TABLET)
		{
			...
			setContentView(R.layout.step_study_guide_main_tablet);
		}
		else
		{
			setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
			setContentView(R.layout.step_study_guide_main);
		}
	...
	private void initWebView()
	{
		...
		if(Feature.IS_TABLET)
		{
			...
			{
				_WebView.loadUrl(Common.WEBVIEW_STUDY_GUIDE_EN_TABLET);
			}
			else
			{
				_WebView.loadUrl(Common.WEBVIEW_STUDY_GUIDE_TABLET);
			}
		}
		else
		{
			if(Feature.IS_LANGUAGE_ENG)
			{
				_WebView.loadUrl(Common.WEBVIEW_STUDY_GUIDE_EN);
			}
			else
			{
				_WebView.loadUrl(Common.WEBVIEW_STUDY_GUIDE);
			}
		}
	...
	{
		_TitleText.setText(CommonUtils.getInstance(this).getLanguageTypeString(R.array.title_study_guide));
	}
