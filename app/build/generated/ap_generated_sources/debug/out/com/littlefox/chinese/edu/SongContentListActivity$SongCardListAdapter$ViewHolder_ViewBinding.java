...
public class SongContentListActivity$SongCardListAdapter$ViewHolder_ViewBinding implements Unbinder {
  private SongContentListActivity.SongCardListAdapter.ViewHolder target;

  @UiThread
  public SongContentListActivity$SongCardListAdapter$ViewHolder_ViewBinding(
      SongContentListActivity.SongCardListAdapter.ViewHolder target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    SongContentListActivity.SongCardListAdapter.ViewHolder target = this.target;
